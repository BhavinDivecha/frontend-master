                                ...
                                <a className="navbar-brand me-0" href="/">
                                    {console.log("setting.logo",setting.logo)}
                                    {
                                        ...
                                        <>
                                        {
                                            ...
                                            (
                                                <img src={`${process.env.protocol}${process.env.baseUrl}uploads/${setting.logo}`} className="navbar-brand-img" alt="..."/>
                                            ) :
                                            (
                                    ...
                                    <ul className='navbar-nav ms-auto'> 
                                            ...
                                            <div style={{'display':"flex"}}>
                                            {
                                                languages && languages.length > 0 && languages.map((lang) => (
                                                        ...
                                                        <a className="nav-link language-nav" onClick={() => handleLanguageChange(lang.name)} title={lang.name}> 
                                                        {
                                                            ...
                                                            (
                                                                <img src={`${process.env.protocol}${process.env.baseUrl}uploads/${lang.logo}`} style={ lang.name == localStorage.getItem('language') ? {height:"10px",width:"20px",cursor:"pointer",boxShadow:"0 1px 5px black"} : {height:"10px",width:"20px",cursor:"pointer"}}/>
                                                            )
                                                            :
                                                            (
                                        ...
                                        </li>
                                        {
                                                ...
                                                (
                                                    <>
                                                        <li className="nav-item dropdown dropdown-full-width">
                                                            <a className="nav-link" href='/auth/login' title='Login'>
