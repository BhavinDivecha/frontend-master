...
export default function Navbar() {
  ...
  const fetchData = async () => {
    ...
    await GetPagesPublic().then(function (res) {
      if (res && res.status == 200) {
    ...
    await GetDepartmentsPublic().then(function (res) {
      if (res && res.status == 200) {
    ...
    await GetLanguagesPublic().then(function (res) {
      if (res && res.status == 200) {
              ...
              <li className="nav-item dropdown">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white fw-medium me-1">
                      {translation.courses}
                    </span>
                  </div>
                </a>
