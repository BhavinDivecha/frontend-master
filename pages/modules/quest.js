...
export default function Courses() {
  ...
  const fetchData = async (course) => {
    await GetCourseById(course).then(function (res) {
                  ...
                  >
                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                      <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                        <div className="ms-4">
                          <span
                            dangerouslySetInnerHTML={{ __html: course.task }}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                      <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                        <div className="ms-4">
                          <span
                            dangerouslySetInnerHTML={{ __html: course.process }}
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="border rounded shadow mb-6 overflow-hidden">
                    ...
                    >
                      ...
                      <div className="px-4">
                        ...
                        <span
                          dangerouslySetInnerHTML={{ __html: course.quiz }}
                        />
                      </div>
                      {/* </div>
                      </div> */}
                    ...
                    >
                      <h5 className="mb-0 w-100">
                        <button
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#EducaorDetails"
                          aria-expanded="false"
                          aria-controls="EducaorDetails"
                        >
                          {/* <span className="me-4 text-dark d-flex">
                            <svg
                              width="15"
                      ...
                      <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                        <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                          <div className="ms-4">
                            <span
                              dangerouslySetInnerHTML={{
                                __html: course.educator_details,
                              }}
                            />
                          </div>
                        </div>
                ...
                >
                  <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                    <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                      ...
                      >
                        <span
                          dangerouslySetInnerHTML={{ __html: course.links }}
                        />
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                    <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                      <div className="ms-4">
                        <span
                          dangerouslySetInnerHTML={{ __html: course.documents }}
                        />
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className="border-top px-5 py-4 min-height-70 d-md-flex align-items-center">
                    <div className="d-flex align-items-center me-auto mb-4 mb-md-0">
                      <div className="ms-4">
                        <span
                          dangerouslySetInnerHTML={{ __html: course.videos }}
                        />
                      </div>
                    </div>
                  </div>
